...
import 'package:curso/main/decorators/decorators.dart';
...
void main() {
  ...
  test('Should throw ForbiddenError if FetchSecureCacheStorage thorws',
      () async {
    mockTokenError();
  ...
  test('Should rethrow if decoratee thorws', () async {
